    ...
    <main>
        <article>
            ...
            <section class="section contact has-bg-image" aria-labelledby="contact-label"
                style="background-image: url('.{{ asset('./assets/images') }}/contact-bg.png')">
                <div class="container">
                        ...
                        <ul class="contact-list">
                            ...
                            <li class="contact-item">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+8801832781875" class="body-lg">+8801832781875</a>
                                </div>
                            ...
                            <li class="contact-item">
                                ...
                                <div>
                                    ...
                                    <a href="tel:emran.khan2400@gmail.com" class="body-lg">emran.khan2400@gmail.com</a>
                                </div>
